...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "INSERT INTO yango_user (username, email, password) VALUES ('$username', '$email', '$password')";
...
<body>
    <div class="signup-container">
        ...
        <p class="mt-3 text-center">Already have an account? <a href="login.php" class="text-danger">Login</a></p>
    </div>
</body>
</html>
